 ...
 * @author Amulya
 */
public class Student4 extends javax.swing.JFrame {
Connection co;
 int id;
    /**
     * Creates new form Student4
     */
    public Student4(Connection con,int id) {
        initComponents();
        co=con;
        this.id=id;
        try
       ...
       ResultSet rs=stmt.executeQuery("select * from wlog where rollNo="+"'"+id+"';");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Student4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
