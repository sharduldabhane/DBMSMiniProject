...
public class Student1 extends javax.swing.JFrame {
 ...
 int id;
     ...
     * 
     */
    public Student1(Connection con,int id) {
        initComponents();
        try
        {
        	this.id=id;
...
//    private void profile_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_timetable_btnActionPerformed
